          ...
          {textarea ? (
            ...
            <input
              ...
              className={clsx(
                ...
                'flex text-lg md:text-xl rounded-xl border-2  focus:border-accentColor hover:border-accentColor pl-4 pr-7 py-2.5 w-full placeholder:font-thin',

                type === 'checkbox' && 'w-5 h-5 mr-5',
              )}
            />
          )}
          {value && !error && type !== 'checkbox' && (
            <span
